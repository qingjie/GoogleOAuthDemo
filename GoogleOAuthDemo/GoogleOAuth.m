...
@synthesize _clientID;
@synthesize _clientSecret;
@synthesize _redirectUri;
@synthesize _authorizationCode;
@synthesize _refreshToken;
@synthesize _scopes;
@synthesize _urlConnection;
@synthesize _receivedData;
@synthesize _accessTokenInfoFile;
@synthesize _refreshTokenFile;
@synthesize _accessTokenInfoDictionary;
